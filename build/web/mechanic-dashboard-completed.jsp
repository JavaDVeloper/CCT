        ...
        <div class="row"><!-- row 2 - for service type -->
            ...
            <div class="col-md-12 col-lg-10 col-xl-10">
                <div class="main-panel main-menu-mechanic">
                    <div>
                        <a href="mechanic-dashboard.jsp" class="main-menu-button"><div class="mechanic-menu">Pending</div></a>
                        <a href="#" class="main-menu-button this-page"><div class="mechanic-menu">Completed</div></a>
            ...
            <div class="col-md-12 col-lg-10 col-xl-10">
                <div class="options-panel">
                    <div class="thin-frame">
                        <c:import url="/calendar/mechanic-completed-table.jsp" />
                    </div>
                </div>
            </div>
            <div class="col-md-0 col-lg-1 col-xl-1">
