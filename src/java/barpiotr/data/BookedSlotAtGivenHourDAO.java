 ...
 */
public class BookedSlotAtGivenHourDAO extends ElementFromDBRetrievableDAO{
    ...
    public BookedSlotAtGivenHourDAO(Integer serviceTime, LocalDateTime checkedTimeSlot){
