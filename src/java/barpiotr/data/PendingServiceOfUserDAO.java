 ...
 */
public class PendingServiceOfUserDAO extends ElementFromDBRetrievableDAO {
    ...
    private PendingServiceOfUser tempElement;

    public PendingServiceOfUserDAO(int customerId) {
        super.sql = "SELECT *"
                    + " FROM service s"
                    ...
                    + " WHERE v.customerId=" + customerId + " AND NOT s.statusName='collected'";
    }
    ...
    public List<ElementFromDBRetrievable> getElementsFromDB(ResultSet myRS) throws Exception{
        ...
        tempElement = new PendingServiceOfUser(vehicleMake, vehicleModel, vehicleRegistration, serviceType, serviceStart, serviceFinish, serviceStatus);
