...
public class ServiceTypeDAO extends ElementFromDBRetrievableDAO {
    ...
    public Map<String, Integer> getElementsTimeMappedFromDB(DataSource dataSource, String sql) throws Exception {
        Map<String, Integer> mapOfServiceTypeTime = new HashMap<>();
        List<ElementFromDBRetrievable> serviceTypeList = getElementFromDBList(dataSource, sql);
